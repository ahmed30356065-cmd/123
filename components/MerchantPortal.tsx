...
const MerchantPortal: React.FC<MerchantPortalProps> = ({ 
  merchant, orders, users, addOrder, messages, seenMessageIds, markMessageAsSeen, hideMessage, deletedMessageIds, onUpdateUser, onUpdateOrderStatus, onLogout
}) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900 text-white flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto pb-24 p-4 hardware-accelerated">
            ...
            {page === 'history' && <OrderList orders={merchantOrders} users={users} />}
