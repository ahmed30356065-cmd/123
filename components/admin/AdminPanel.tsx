...
const AdminPanel: React.FC<AdminPanelProps> = (props) => {
    ...
    const handleScroll = (e: React.UIEvent<HTMLElement>) => {
        ...
        // Save scroll position for orders view
        if (view === 'orders') {
    ...
    const renderView = () => {
        switch (view) {
            ...
            case 'add_order': return <AddOrderModal merchants={merchants} onClose={() => setView('orders')} onSave={props.adminAddOrder} />;
    ...
    return (
        <div className={`flex flex-col h-screen overflow-hidden ${currentAdminMode === 'light' ? 'bg-gray-100' : 'bg-gray-900'}`}>
            ...
            >
                ...
                {view === 'wallet' && <AdminWalletScreen orders={props.orders} users={props.users} payments={props.payments} updateUser={props.updateUser} handleDriverPayment={props.handleDriverPayment} onDeletePayment={props.deletePayment} currentUser={props.user} />}
