    ...
    return (
        <div className={`flex flex-col h-screen overflow-hidden ${currentAdminMode === 'light' ? 'bg-gray-100' : 'bg-gray-900'}`}>
            ...
            >
                ...
                {view === 'wallet' && <AdminWalletScreen orders={props.orders} users={props.users} payments={props.payments} updateUser={props.updateUser} handleDriverPayment={props.handleDriverPayment} />}
