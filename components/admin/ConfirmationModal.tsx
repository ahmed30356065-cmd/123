...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return createPortal(
    <div 
        className={`fixed inset-0 z-[100] flex items-center justify-center p-4 transition-all duration-300 ease-out ${isVisible ? 'backdrop-blur-[2px] bg-black/5' : 'opacity-0 pointer-events-none'}`}
        onClick={handleClose}
